    ...
    <form class="registration_form" action="{{ route('register') }}" method="post">
        ...
        <dl class="form-list">
            <div class="input_group">
                <label for="registration_name" id="l_registration_name">ユーザーネーム</label>
                <input class="registration_box" id="registration_name" type="text" name="name"
                    value="{{ old('name') }}" placeholder="ユーザーネーム">
            ...
            <div class="input_group">
                <label for="registration_password_confirmation" id="l_registration_password_confirmation">パスワード(確認用)</label>
